package com.unicom.wx.mp.handler;
...
import com.unicom.wx.mp.builder.TextBuilder;
import com.unicom.wx.mp.entity.WxMpUserEntity;
import com.unicom.wx.mp.event.WxMpUserSubscribeEvent;
import com.unicom.wx.mp.handler.scan.ScanStrategyContext;
...
public class SubscribeHandler extends AbstractHandler {
    ...
    public WxMpXmlOutMessage handle(WxMpXmlMessage wxMessage,
        ...
        try {
            return new TextBuilder().build("你好，欢迎来到采集平台！", wxMessage, weixinService);
        } catch (Exception e) {
            this.logger.error(e.getMessage(), e);
        }
